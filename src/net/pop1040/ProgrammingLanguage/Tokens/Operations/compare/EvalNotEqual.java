...
public class EvalNotEqual implements Evaluatable {
	
	Evaluatable a, b;

	public EvalNotEqual(Evaluatable a, Evaluatable b) {
		this.a=a;
		this.b=b;
	}
	...
	public PGeneric getReturnValue(FunctionStack stack, ArrayList<PGeneric> evaluated) {
		if(!(evaluated.get(0) instanceof PPrimitive && evaluated.get(0) instanceof PPrimitive)){
