...
public class EvalSubtractDouble implements Evaluatable{
	
	Evaluatable a, b;
	public PClass returnType = PInteger.pClass;
	
	public EvalSubtractDouble(Evaluatable a, Evaluatable b) {
		this.a=a;
		this.b=b;
	}
	...
	public PGeneric getReturnValue(FunctionStack stack, ArrayList<PGeneric> evaluated) {
		...
		return new PDouble(((PPrimitive)evaluated.get(0)).getDoubleValue() - ((PPrimitive)evaluated.get(1)).getDoubleValue());
	}
